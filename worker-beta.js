...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Sparoney/goindex@master/v3/css/bootstrap/${uiConfig.dark_mode ? 'dark' : 'light'}.min.css">
  <style>${uiConfig.display_size ? '' : '.csize{display:none;}'}${uiConfig.display_time ? '' : '.cmtime{display:none;}'}</style>
  <script src="https://cdn.jsdelivr.net/gh/Sparoney/goindex@master/v3/js/app.js"></script>
  <script src="https://cdn.jsdelivr.net/gh/Sparoney/goindex@master/v3/js/mdui.min.js"></script>
  <script src="//cdn.jsdelivr.net/npm/markdown-it@10.0.0/dist/markdown-it.min.js"></script>
</head>
<body>
</body>
<script src="https://cdn.jsdelivr.net/gh/Sparoney/goindex@master/v3/js/bootstrap.min.js"></script>
</html>`;
};
...
async function handleRequest(request) {
    ...
    if (path.substr(-1) == '/' || action != null) {
        ...
        const inline_down = !(command && command == "down");
