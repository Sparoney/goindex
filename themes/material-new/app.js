...
function append_files_to_list(path, files) {
    ...
    for (i in files) {
        ...
        item['modifiedTime'] = utc2melbourne(item['modifiedTime']);
...
// Time conversion
function utc2melbourne(utc_datetime) {
    ...
    // Add 10 hours, Melbourne (AEST) is 11 hours ahead of UTC
    var unixtimestamp = timestamp + 10 * 60 * 60;
