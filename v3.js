...
const uiConfig = {
	...
	"logo_link_name": "Driveflix", // if logo is true then link otherwise just text for name
	...
	"company_name": "Driveflex", // Name next to copyright
...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Sparoney/goindex@master/v3/css/mdui-style.min.css">
  <script src="https://cdn.jsdelivr.net/combine/gh/jquery/jquery@3.2/dist/jquery.min.js"></script>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/https://cdn.jsdelivr.net/gh/Sparoney/goindex@master/v3/css/bootstrap/${uiConfig.dark_mode ? 'dark' : 'light'}.min.css">
  <script src="https://cdn.jsdelivr.net/https://cdn.jsdelivr.net/gh/Sparoney/goindex@master/v3/js/app.min.js"></script>
  <script src="https://cdn.jsdelivr.net/https://cdn.jsdelivr.net/gh/Sparoney/goindex@master/v3/js/mdui.min.js"></script>
  <script src="//cdn.jsdelivr.net/npm/markdown-it@10.0.0/dist/markdown-it.min.js"></script>
</head>
<body>
</body>
<script src="https://cdn.jsdelivr.net/https://cdn.jsdelivr.net/gh/Sparoney/goindex@master/v3/js/bootstrap.min.js"></script>
</html>`;
};
